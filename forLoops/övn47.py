""" En kommun gör följande prognos för befolkningsutvecklingen de närmaste
         åren:
         Vid början av 2020 hade komunen 26000 invånare.
         Antal födda och avlidna uppskattas till 0.7 % respektive 0.6 % av
         befolkningen vid årets början
         Antal inflyttade och utflyttade upskattas till 300 respektive 325 varje år
         Beräkna kommunens uppskattade invånarantal i början av ett visst år.
         Vilket år det gäller ska läsas in som indata
